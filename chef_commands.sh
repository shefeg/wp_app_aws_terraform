...
while ! sudo chef-client cookbooks/wp-app/recipes/default.rb -z; do 
    echo "Wait for chef-client. Retrying..." && sleep 5
done

# sudo chef-client cookbooks/wp-app/recipes/default.rb -z
